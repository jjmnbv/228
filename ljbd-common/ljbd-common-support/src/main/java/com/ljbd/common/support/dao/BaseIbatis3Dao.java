...
public abstract class BaseIbatis3Dao<E,PK extends Serializable> extends DaoSupport {
    ...
    public Object getById(PK primaryKey) {
	  ...
	  public int deleteById(PK id) throws DataAccessException {
        return this.getSqlSessionTemplate().delete(getDeleteStatement(), id);
    }

    public int save(E entity) throws DataAccessException {
        prepareObjectForSaveOrUpdate(entity);
        return this.getSqlSessionTemplate().insert(getInsertStatement(), entity);

    }

	 public int update(E entity) throws DataAccessException {
        prepareObjectForSaveOrUpdate(entity);
        return this.getSqlSessionTemplate().update(getUpdateStatement(), entity);
    }
