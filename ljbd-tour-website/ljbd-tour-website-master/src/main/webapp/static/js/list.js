$(document).ready(function(){
	...
	$("#sLeftBtnB").click(function(){
		if($(this).attr("class")=="sLeftBtnBSel") {
			...
			leftPosition=leftPositionNum+162+"px";
			if(leftPosition=="0px") {if($(this).attr("class") != "sLeftBtnBBan") {$(this).attr("class","sLeftBtnBBan");}}
			var bestLeftNum=-($(".scrolltab .ulSmallPic li").length-6)*162;
			if((leftPositionNum+162) > bestLeftNum && $("sRightBtnB").attr("class") != "sRightBtnB") {$("#sRightBtnB").attr("class","sRightBtnB")}
	...
	$("#sRightBtnB").click(function(){
		if($(this).attr("class")=="sRightBtnBSel"){
			...
			leftPosition=leftPositionNum-162+"px";
			var bestLeftNum=-($(".scrolltab .ulSmallPic li").length-6)*162;
			if((leftPositionNum-162)==bestLeftNum) {$(this).attr("class","sRightBtnBBan");}
